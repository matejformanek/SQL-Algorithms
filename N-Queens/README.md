...
Problem where u are given a chess board of size N * N and your goal is to place N Queens on the board with the rule that no 2 Queens can attack each other.
